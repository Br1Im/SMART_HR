...
let ContactsController = class ContactsController {
    ...
    findAll(req, page, limit, search, orgId) {
        const pageNum = page ? parseInt(page, 10) : 1;
        const limitNum = limit ? parseInt(limit, 10) : 10;
        return this.contactsService.findAll(req.user.id, req.user.role, pageNum, limitNum, search, orgId);
    }
    findOne(id, req) {
        return this.contactsService.findOne(id, req.user.id, req.user.role);
    }
    update(id, updateContactDto, req) {
        return this.contactsService.update(id, updateContactDto, req.user.id, req.user.role);
    }
    remove(id, req) {
...
__decorate([
    ...
    (0, resource_decorator_1.Resource)('contacts'),
