                ...
                {selectedQuestion ? (
                  ...
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center">
                      <h3 className="text-lg text-gray-900 mb-2">Выберите вопрос для редактирования</h3>
                      <p className="text-gray-500">Выберите вопрос из списка слева или создайте новый</p>
                    </div>
                  </div>
                )}
              </div>
