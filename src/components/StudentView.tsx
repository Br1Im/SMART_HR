          ...
          <Card className="mb-6 border-blue-200 bg-blue-50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="text-lg text-gray-900 mb-2">{quiz.title}</h4>
                  {quiz.description && (
              ...
              {lastAttempt && (
                <div className="mb-4 p-3 bg-white rounded border">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Последняя попытка:</span>
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-500">Режим обучения</div>
            </div>
          </div>
          ...
          {course.modules.map((module) => (
            <div key={module.id}>
              <div className="px-4 py-3 bg-gray-50 border-b">
                <h3 className="text-sm text-gray-900">{module.title}</h3>
              </div>
              <div>
      ...
      <div className="flex-1 overflow-y-auto">
        {selectedLesson ? (
          <div className="max-w-4xl mx-auto p-8">
            <div className="mb-8">
              <h1 className="text-2xl text-gray-900 mb-2">{selectedLesson.title}</h1>
